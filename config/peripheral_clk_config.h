...
#define CONF_GCLK_AC_FREQUENCY 12000000
#endif
...
// <y> Measurement Clock Source
// <id> freqm_msr_selection
...
// <i> Select the clock source for MSR (measurement clock).
#ifndef CONF_GCLK_FREQM_MSR_SRC
#define CONF_GCLK_FREQM_MSR_SRC GCLK_PCHCTRL_GEN_GCLK0_Val
#endif

// <y> Reference Source
// <id> freqm_ref_selection
...
// <i> Select the reference clock source.
#ifndef CONF_GCLK_FREQM_REF_SRC
#define CONF_GCLK_FREQM_REF_SRC GCLK_PCHCTRL_GEN_GCLK3_Val
#endif

/**
 * \def CONF_GCLK_FREQM_REF_FREQUENCY
 * \brief FREQM's Reference Clock frequency
 */
#ifndef CONF_GCLK_FREQM_REF_FREQUENCY
#define CONF_GCLK_FREQM_REF_FREQUENCY 32768
#endif
